...
/*
  Managers for Widget Co. get promoted when they get more employees, and get a bonus when 
  they fire employees. create a class ProgressiveManager that extends Manager. A Progressive Manager 
  has all of the same properties as a manager with the following additional properties:
...
class Machine {
  constructor(widget_made_count, wear_and_tear_count, needs_reboot){
  ...
  makeWidgets(num){
    ...
    if(this.widget_made_count % 50 === 0 ){
